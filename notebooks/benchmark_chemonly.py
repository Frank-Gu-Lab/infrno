# -*- coding: utf-8 -*-
"""
Benchmark modelling pipelines using only chemical features and molecular weight.
"""
import pandas as pd
import numpy as np
...
modelling_df = modelling_df.drop(columns=['corr_%_attenuation0.25', 'corr_%_attenuation0.5',
                                          ...
                                          'corr_%_attenuation1.75','corr_%_attenuation0.25_std',
...
f1_scores.to_csv("../data/processed/chemonly_f1.csv")
best_fully_trained_params.to_csv("../data/processed/chem_bestparams.csv")
